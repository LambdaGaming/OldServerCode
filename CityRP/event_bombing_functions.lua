...
--[[
	...
	Nazi Invasion RP server.
	
	Reason for Removal: Event was removed due to people complaining about getting killed by the
	explosions, especially when the mayor selected the wrong option on purpose.
]]
